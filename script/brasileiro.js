...
fetch("https://v3.football.api-sports.io/fixtures/rounds?season=2021&league=4", {
	"method": "GET",
	"headers": {
...
.then(response => response.json().then(data => {
    ...
    var fixture = matchesList[0]['seasons'][11]['coverage']['fixtures'];
    console.log(fixture);
